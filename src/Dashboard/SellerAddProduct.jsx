                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="focus:outline-none grid gap-4 mb-4 sm:grid-cols-2">
                                        ...
                                        <div className="flex justify-between gap-5 col-span-2 w-full">
                                            ...
                                            <LazyLoadImage src={imageSrc ? imageSrc : upload} className='w-28' alt='upload image' />
                                        </div>
                                            ...
                                            <div className='flex gap-2'>
                                                {
                                                    imagesSrc ?
                                                        imagesSrc.map((img, idx) => {
                                                            return <LazyLoadImage src={img} className='w-24 h-24 border rounded' key={idx} alt={`image${idx}`} />
                                                        })
                                                        : <LazyLoadImage src={upload} className='w-28' alt='uploaded' />
                                                }
                                            </div>
                                        </div>

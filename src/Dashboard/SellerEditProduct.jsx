                    ...
                    <form onSubmit={uploadData}>
                        <div className="focus:outline-none grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div className='flex justify-between gap-5 w-full'>
                                ...
                                <LazyLoadImage src={imageSrc ? imageSrc : img} className='w-28 h-28' alt='image' />
                            </div>
                                ...
                                <div className='flex gap-2'>
                                    {
                                        imagesSrc ?
                                            imagesSrc.map((img, idx) => {
                                                return <LazyLoadImage src={img} className='w-24 h-24 border rounded' key={idx} alt='image' />
                                            })
                                            : multipleImages.map((img) => {
                                                return <LazyLoadImage src={img.name} className='w-24 h-24 border rounded' key={img.id} alt='image' />
                                            })
                                    }
                                </div>
                            </div>

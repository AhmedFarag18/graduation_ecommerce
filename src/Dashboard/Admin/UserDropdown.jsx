  ...
  return (
    <>
      ...
      <div ref={popoverDropdownRef} className={(dropdownPopoverShow ? "block " : "hidden ") + "bg-white text-base z-50 float-left list-none text-left rounded shadow-lg min-w-48"}>
        ...
        <Link to={`/dashboard/profile?user=${authUser.email}`} className={"text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-indigo-700 hover:bg-main-color hover:text-white transition duration-300 rounded-sm"}>
          Profile
        </Link>

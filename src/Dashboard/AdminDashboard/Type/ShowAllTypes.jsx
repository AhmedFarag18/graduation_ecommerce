                                                    ...
                                                    return (
                                                        <tr className="hover:bg-gray-100 " key={item.id}>
                                                            ...
                                                            <td className="p-4 space-x-2 whitespace-nowrap">
                                                                ...
                                                                <Link to={`/dashboard/deleteType/${item.id}`} id="deleteProductButton" className="inline-flex gap-1 items-center px-3 py-2  text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300">

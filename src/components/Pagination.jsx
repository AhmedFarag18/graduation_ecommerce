                ...
                <div className="w-full  flex items-center justify-between border-t border-gray-200">
                    ...
                    <div className="sm:flex hidden">
                        {pageNumbers.map((pageNumber) => (
                            <p key={pageNumber} className={`text-sm font-medium leading-none cursor-pointer pt-3 mr-4 px-2 ${pageNumber === currentPage ? "text-indigo-700 border-t border-indigo-400" : "text-gray-600 hover:text-indigo-700 border-t border-transparent hover:border-indigo-400"}`}
